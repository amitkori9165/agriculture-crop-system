...
//		updating crop table for crop_status
		DealersCrop crop = restTemplate.getForEntity(ROOT_URI2 + "/showCropsByBookingId/"+bookingId, DealersCrop.class).getBody();
		String cropStatus = crop.getCropStatus();
		if(cropStatus.equals("BOOKED")) {
