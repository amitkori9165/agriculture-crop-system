...
import com.farmers.model.Receipt;
...
public class FarmerServicesImpl implements FarmerServices{
	...
	public List<Receipt> showReceipts(int farmerId) {
		
		Receipt[] receiptArr = restTemplate.getForEntity(ROOT_URI + "/showReceiptsByFarmerId/"+farmerId , Receipt[].class).getBody();
